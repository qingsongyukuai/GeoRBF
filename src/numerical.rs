...
pub(crate) struct EqualityKktNumericalPolicy {
    ...
    pub(crate) convex_standard_retry_residual_limit: f64,
    pub(crate) convex_certificate_residual_limit: f64,
    pub(crate) convex_certificate_separation_limit: f64,
    ...
    pub(crate) quotient_householder_orthogonality_limit: f64,
    pub(crate) quotient_canonical_response_round_trip_limit: f64,
    pub(crate) quotient_llt_backward_error_limit: f64,
    pub(crate) quotient_field_energy_identity_limit: f64,
    pub(crate) quotient_basis_side_condition_limit: f64,
    pub(crate) quotient_basis_recovery_round_trip_limit: f64,
    pub(crate) quotient_basis_response_round_trip_limit: f64,
    ...
    pub(crate) query_field_scale_tolerance_multiplier: f64,
    pub(crate) query_sample_reference_tolerance_multiplier: f64,
...
pub(crate) const EXECUTED_NUMERICAL_POLICY: EqualityKktNumericalPolicy =
    EqualityKktNumericalPolicy {
        ...
        query_field_scale_tolerance_multiplier: 1.0e-12,
        query_sample_reference_tolerance_multiplier: 1.0e-11,
